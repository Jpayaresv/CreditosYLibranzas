<template>
  <q-page padding >
    ...
    <div style="display: flex; align-items: center; justify-content: start; margin: 2rem 0 0 2rem; font-size: 38px; font-weight: bolder;">Simula tu Crédito</div>
    ...
    <div style="align-items: center; display: flex; align-items: center; justify-content: start; margin: 1rem 0 0 2rem;">
      <q-input v-model="moneyRequired" :ref="moneyRequired"  @update:modelValue="updateMoneda" label="ㅤ¿Cuánto dinero necesitas?" prefix="ㅤ$" type="text" onkeydown="javascript: return ['Backspace','Delete','ArrowLeft','ArrowRight'].includes(event.code) ? true : !isNaN(Number(event.key)) && event.code!=='Space'" style="width: 520px;; background-color: #f5f6f7" />
  </div>
  <div style="margin: 3rem 0 3rem 2.3rem; width: 510px;">
    <q-slider
      class="q-mt-xl"
      v-model="priceModel"
      color="teal-10"
...
<div style="display: flexbox; margin: auto; width: 30rem; height: 20rem; background-color: #f4f4f4; padding: 2rem 1rem 0 1rem; border-radius: 5px; margin-top: 50px;">

  <div v-if="!showprogress">
    <span style="margin: 20px 0 0 20px; font-size: 32px; font-weight: bold;">$ <!-- {{ cuotamensual }} --> 394.248 <span style="font-size: 20px; font-weight: 300;">/mes</span> </span>
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; width: 90%; margin: 8px 0 0 20px;">
...
<div v-if="showprogress" style="padding: 0; margin: -2rem 0 -1.15rem 0 ;">
  ...
  <div v-if="showTwoButtons" style="display: flex; align-items: center; justify-content: center; width: 100%; margin: 40px 0 0 0px; position: static;justify-content: space-around;">
    <q-btn push  label="Recalcular" color="primary"  :disable="disableButtonRecalcular" @click="funcionParaRecalcular()"></q-btn>
    <q-btn push  label="Solicitar Crédito" color="green" @click="null"></q-btn>
  </div>

  <div v-if="!showTwoButtons" style="display: flex; align-items: center; justify-content: center; width: 100%; margin: 40px 0 0 0px; position: static;justify-content: space-around;">
    <q-btn push  label="Calcular" color="primary" size="15px" :disable="disableButtonCalcular" @click="funcionParaMetodoQueCalculaElCredito()"></q-btn>
  </div>
...
<div style="display: flex; flex-direction: column; align-items: center; margin: 4% 0 0 0; font-size: 25px; color: blue;">¡Utiliza tu crédito para lo que quieras!
  <span style="font-size: 16px; margin-top: 10px; color: black;">Dentro del proceso puedes elegir qué destino quieres para tu dinero</span>
</div>
<div style="display: flex; justify-content: space-around; margin: 4% auto 0 auto; width: 75%;">
  <q-card :flat="true">
      <q-card-section style="display: flex; flex-direction: column; align-items: center;" >
        ...
        <div style="display: flex; margin-top: 10px; align-items: center; justify-content: center; font-size: 14px; font-weight: bold;">Libranza</div>
      </q-card-section>
  </q-card>
  <q-card :flat="true" >
      <q-card-section style="display: flex; flex-direction: column; align-items: center;">
        <q-icon name="menu_book" size="2.5em" style="opacity: 80%;" />
        <div style="display: flex; margin-top: 10px; align-items: center; justify-content: center; font-size: 14px; font-weight: bold;">Estudio</div>
      </q-card-section>
  </q-card>
  ...
  <q-card :flat="true">
      <q-card-section style="display: flex; flex-direction: column; align-items: center;" >
        ...
        <div style="display: flex; margin-top: 10px; align-items: center; justify-content: center; font-size: 14px; font-weight: bold;">Viajes</div>
      </q-card-section>
  </q-card>
  <q-card :flat="true">
      <q-card-section style="display: flex; flex-direction: column; align-items: center;" >
        <q-icon name="trending_up" size="2.5em" style="opacity: 80%;" />
        <div style="display: flex; margin-top: 10px; align-items: center; justify-content: center; font-size: 14px; font-weight: bold;">Invertir</div>
      </q-card-section>
  </q-card>
  <q-card :flat="true">
      <q-card-section style="display: flex; flex-direction: column; align-items: center;" >
        <q-icon name="directions_car" size="2.5em" style="opacity: 80%;" />
        <div style="display: flex; margin-top: 10px; align-items: center; justify-content: center; font-size: 14px; font-weight: bold;">Comprar<br>Vehículo</div>
      </q-card-section>
  </q-card>
  <q-card :flat="true">
      <q-card-section style="display: flex; flex-direction: column; align-items: center;" >
        <q-icon name="medication" size="2.5em" style="opacity: 80%;" />
        <div style="display: flex; margin-top: 5px; align-items: center; justify-content: center; font-size: 14px; font-weight: bold;">&nbsp;Salud y<br>Bienestar</div>
      </q-card-section>
  </q-card>
...
let listadoVehbyHour = ref( [{hour: '0:00', number: 765},
